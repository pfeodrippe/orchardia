(ns compliment.sources.namespaces-and-classes
  ...
  (:require [compliment.sources :refer [defsource]]
            ...
            #_[compliment.sources.class-members :refer [classname-doc]]))
...
#_(defn all-classes-short-names
...
#_(defn- get-classes-by-package-name
...
(defn candidates
  ...
  (when (nscl-symbol? prefix)
    (let [#_ #_has-dot (> (.IndexOf prefix ".") -1)
          #_ #_import-ctx (analyze-import-context context)]
      ((comp distinct concat)
       ...
       #_(cond (= import-ctx :root) (get-all-full-names prefix)
